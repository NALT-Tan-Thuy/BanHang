    ...
    public function getajaxSanPhamTimKiem($arr)
    {
        ...
        foreach ($chitietsanpham as $ctsp) {
            ...
            if ($ctsp->khuyenmai == 0) {
                ...
                $s = $s . '<span class="flash-del">' . number_format(round($ctsp->giagoc, -3), '0', '', '.') . 'đ</span>
                <span class="flash-sale">' . number_format(round($ctsp->giagoc - $ctsp->giagoc * $ctsp->khuyenmai / 100, -3), '0', '', '.') . 'đ</span>' . '<div class="ribbon-wrapper">
